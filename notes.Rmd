---
title: "Class NOTES"
subtitle: "Comm 290: Intro to Data Analysis for Communication"
author: "Jin Woo Kim"
...
- No prerequisite (for beginners)

- You should take this course if
  + interested in data science &
  + no to little experience with statistical computing (especially R)
  
    
- You probably **shouldn't** if 
  + taken two or more related courses &
  + can run regressions using R
...
- Real-time attendance is recommended but not mandatory
- Video of each class will be uploaded on Canvas
  + You should watch it and send me your code before next class
- Mute your audio unless you have something to say
- Recommended: for coding-related questions, use the chat bar in Blue Jeans
  + In most cases, I need to see your code to figure out what's going on
  + Start by saying "I have a question"
- But it may be difficult to troubleshoot in real time
  + Keep in mind: the vast majority of errors occur because of typos
  + Contact me for a troubleshooting session if you kept getting errors, and fell behind
    + We will go over your code and debug together
- Let me know if you have any technical issues (poor connection, etc)


## Homeworks

- Five official homework assignments throughout the semester
  - Will ask you to use the tools covered in class to analyze other datasets
  - You will be able to complete them using the instructions provided during class
  - Each homework will be distributed 2 weeks before due date

- Minor impromptu assignments
  - Taking surveys, pilot experiments, commenting, etc.
  - Short
  - Graded on submission (participation score)
...
- Slides, assignments, datasets, updated syllabus, etc will be posted on Canvas
- First two chapters of our textbook
- Use the Discussion boards to ask coding-related or logistical questions
  + If you see a question that you can answer, don't hesitate!
  + You will receive participation credits for answering questions on Canvas
- Email me for private questions
...
## House Keeping
- HW1 is up on Canvas (due on 9/17)
- Submit your R script file (due before next class)
